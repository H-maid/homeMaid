@include('Admin.header')
    <div class="agencyListPage ExplorerListPage">
        <div class="layout-content">
          <div class="layout-content-body">
              <div class="title-bar">

                  <h1 class="title-bar-title">
                    <span class="d-ib">Agency List</span>
                  </h1>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          ...
          <div class="m-t-lg">
            <a class="btn btn-danger BlockUserAgencyManagementContinue" type="button">Continue</a>
