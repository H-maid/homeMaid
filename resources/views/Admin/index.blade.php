    ...
    <div class="layout-content-body">
        <div class="title-bar">
            ...
            <p class="title-bar-description">
                <small>Welcome to House Maid</small>
            </p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <span class="icon icon-user"></span>
                            ...
                            <div class="media-middle media-body">
                                <h6 class="media-heading">Total Maid</h6>
                                <h3 class="media-heading">
                        <span class="fw-l">{{$data['maid']}}</span>
                      </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <span class="icon icon-shopping-bag"></span>
                            ...
                            <div class="media-middle media-body">
                                ...
                                <h3 class="media-heading">
                        <span class="fw-l">{{$data['user']}}</span>
                      </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="icon icon-clock-o"></span>
                            ...
                            <div class="media-middle media-body">
                                <h6 class="media-heading">Total Agency</h6>
                                <h3 class="media-heading">
                        <span class="fw-l">{{$data['agency']}}</span>
                      </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <span class="icon icon-usd"></span>
                            ...
                            <div class="media-middle media-body">
                                ...
                                <h3 class="media-heading">
                        <span class="fw-l">{{$data['today_registered']}}</span>
                      </h3>
                            </div>
                        </div>
                    </div>
