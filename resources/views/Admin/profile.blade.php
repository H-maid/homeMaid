                ...
                <div class="profile-container">
                    <div class="profile-card">
                        <div class="profile-avetar">
                            ...
                            <img class="profile-avetar-img" width="128" height="128" src="{{asset('Admin/img/0180441436.jpg')}}" alt="{{Auth::guard('admin')->user()->name}}"> @else @if(App::environment() == 'local')
                            <img class="profile-avetar-img" width="128" height="128" src="{{asset('Admin/img')}}/{{Auth::guard('admin')->user()->profile}}" alt="{{Auth::guard('admin')->user()->name}}"> @else
                            <img class="profile-avetar-img" width="128" height="128" src="{{url('public/Admin/img')}}/{{Auth::guard('admin')->user()->profile}}" alt="{{Auth::guard('admin')->user()->name}}"> @endif @endif
                        </div>
